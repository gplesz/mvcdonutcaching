...
namespace DevTrends.MvcDonutCaching.Demo.Controllers
{
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_AccountController : DevTrends.MvcDonutCaching.Demo.Controllers.AccountController
    {
        ...
        partial void LogInOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, DevTrends.MvcDonutCaching.Demo.Models.LogOnModel model, string returnUrl);

        public override System.Web.Mvc.ActionResult LogIn(DevTrends.MvcDonutCaching.Demo.Models.LogOnModel model, string returnUrl)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.LogIn);
        ...
        partial void RegisterOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, DevTrends.MvcDonutCaching.Demo.Models.RegisterModel model);

        public override System.Web.Mvc.ActionResult Register(DevTrends.MvcDonutCaching.Demo.Models.RegisterModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Register);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "model", model);
        ...
        partial void ChangePasswordOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, DevTrends.MvcDonutCaching.Demo.Models.ChangePasswordModel model);

        public override System.Web.Mvc.ActionResult ChangePassword(DevTrends.MvcDonutCaching.Demo.Models.ChangePasswordModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.ChangePassword);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "model", model);
